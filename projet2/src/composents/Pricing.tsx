                        ...
                        <div key={index} className="w-full sm:w-1/2 lg:w-1/3 p-2">
                            <div className="p-10 border border-neutral-700 rounded-xl">
                                <p className="text-4xl mb-8">
                                    {Option.title}
                                    {Option.title === "pro" && (
                                        <span className="bg-gradient-to-r from-orange-500 to-red-400 text-transparen bg-clip-text text-xl mb-4 ml-2">
                                        (Most Popular)
                                        </span> 
                                   )}
                                </p>
                                <p className="mb-8">
                                    ...
                                    <span className="text-neutral-400 trancing-tight">/Month</span>
                                </p>
                                <ul>
